...
export const metadata = {
  ...
  description:
    "Apoio completo para vender ao governo: radar de editais, propostas, impugnações, recursos e gestão de contratos.",
};
    ...
    <main className="mx-auto max-w-6xl px-4 py-12">
      <section className="rounded-3xl border bg-gradient-to-br from-white to-gray-50 p-8 md:p-12">
        ...
        <p className="mt-3 max-w-2xl text-gray-700">
          ...
          negócio. Da busca de editais à gestão do contrato — com segurança e velocidade.
        </p>
      ...
      <section className="mt-12 grid gap-8 md:grid-cols-2">
        ...
        <div className="rounded-2xl border p-6">
          ...
          <ul className="mt-4 space-y-2 text-gray-700">
            ...
            <li>• Redução de custos internos na operação B2G</li>
        ...
        {[
          {
            ...
            desc: "Editais por CNAE/keywords, com análise de viabilidade e prazos.",
          },
          {
            title: "Proposta express",
            desc: "Montagem de proposta com checklist e conferência final.",
          },
          {
      ...
      <section className="mt-12 rounded-2xl border p-6">
        <h2 className="text-xl font-semibold">Vamos rodar uma triagem gratuita?</h2>
        <p className="mt-2 text-gray-700">
          Conte seu segmento e região. Em 24–48h, retornamos com oportunidades quentes (sem compromisso).
        </p>
